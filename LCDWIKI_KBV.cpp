...
*/
		...
		case 0x101: // display id "257" em hexa
			lcd_driver = ID_7789;
			XC=0x2A,YC=0x2B,CC=0x2C,RC=HX8357_RAMRD,SC1=0x33,SC2=0x37,MD=0x36,VL=0,R24BIT=0;
			static const uint8_t ST7789V_regValues[] PROGMEM = 
			{
				0xF0, 1, 0xC3,           
		    	0xF0, 1, 0x96, 
		    	0x36, 1, 0x08, 
			...
			init_table8(ST7789V_regValues, sizeof(ST7789V_regValues));
			break;
		default:
